  ...
  item.addEventListener("click", () => {
    ...
    if (item.classList.contains("faq-item--active")) {
      ...
      document
        ...
        .forEach((el) => el.classList.remove("faq-item--active"));
...
new Swiper(".cases-swiper", {
  ...
  speed: 750,
  navigation: {
    prevEl: ".arrow--cases-prev",
    nextEl: ".arrow--cases-next",
  },
  breakpoints: {
    301: {
      slidesPerView: 1,
...
new Swiper(".experience-swiper", {
  ...
  speed: 750,
  navigation: {
    prevEl: ".arrow--experience-prev",
    nextEl: ".arrow--experience-next",
  },
  breakpoints: {
    301: {
      slidesPerView: 1,
...
new Swiper(".team-swiper", {
  ...
  speed: 750,
  navigation: {
    prevEl: ".arrow--team-prev",
    nextEl: ".arrow--team-next",
  },
  breakpoints: {
    301: {
      slidesPerView: 1,
